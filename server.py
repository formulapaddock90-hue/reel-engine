        ...
        if self.path.startswith('/api/render-reel'):
            ...
            try:
                ...
                vf = (
                    ...
                    f"drawbox=x=30:y=40:w=300:h=60:color=#080a11@0.72:t=fill,"
                    f"drawbox=x=30:y=40:w=300:h=60:color=#e10600@0.85:t=2,"
                    f"drawtext=text='FORMULAPADDOCK.IT'{font_part}:fontcolor=white:fontsize=22:x=45:y=58,"
                    f"drawbox=x={targetW-240}:y=40:w=210:h=110:color=#080a11@0.72:t=fill,"
                    f"drawbox=x={targetW-240}:y=40:w=210:h=110:color=white@0.12:t=1,"
                    ...
                    f"drawbox=x=40:y={targetH-240}:w={targetW-80}:h=160:color=#0b0f19@0.78:t=fill:enable='lt(t,12)',"
                    f"drawbox=x=40:y={targetH-240}:w={targetW-80}:h=160:color=white@0.08:t=1:enable='lt(t,12)',"
                    f"drawbox=x=40:y={targetH-240}:w=6:h=160:color=#e10600@1.0:t=fill:enable='lt(t,12)',"
                    ...
                    f"drawbox=x=0:y=0:w={targetW}:h={targetH}:color=#07090e@0.95:t=fill:enable='gte(t,12)',"
                    f"drawbox=x=30:y=30:w={targetW-60}:h={targetH-60}:color=#e10600@0.85:t=2:enable='gte(t,12)',"
                    f"drawbox=x=50:y=160:w={targetW-100}:h={targetH-320}:color=#0b0f19@0.82:t=fill:enable='gte(t,12)',"
                    f"drawbox=x=50:y=160:w={targetW-100}:h={targetH-320}:color=white@0.08:t=1:enable='gte(t,12)',"
